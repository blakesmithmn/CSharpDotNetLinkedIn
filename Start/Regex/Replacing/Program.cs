...
string result = CapWords.Replace(teststr1, "***"); // replaces capitalized words w 3 *'s
Console.WriteLine(teststr1);
Console.WriteLine(result); // *** quick brown *** jumps over the lazy ***
...
Console.WriteLine(teststr1); // The quick brown Fox jumps over the lazy Dog

Console.WriteLine(upperstr); // The quick brown FOX jumps over the lazy DOG
