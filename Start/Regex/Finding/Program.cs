...
using System.Text.RegularExpressions; // must be explicitly included
...
Regex CapWords = new Regex(@"[A-Z]\w+"); // a to z followed by non whitespace one or more

Console.WriteLine(CapWords.IsMatch(teststr1)); // true
Console.WriteLine(CapWords.IsMatch(teststr2)); // false
